...
class SimpleClient(discord.Client):
    ...
    async def count(self, text):
        ...
        table = tabulate.tabulate(data, headers=["Name", "# of " + text, "# of messages",
                                                 "% of messages with " + text + " in it",
